                ...
                <div className="childright">
                    <div className="content">
                        ...
                        <div className="socialAbout">
                            ...
                            <a href='https://github.com/apoorv-121' target="_blank" rel="noreferrer"><FaGithubSquare/> Github</a >
                            <a href='https://www.linkedin.com/in/apoorv-jha-501/' target="_blank" rel="noreferrer"><BsLinkedin/>  LinkedIn</a >
                        </div>
                    </div>
                </div>
            </div>
